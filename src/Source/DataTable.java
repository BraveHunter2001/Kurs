...
public class DataTable {
    ...
    public DataTable(List<Character> lines)
    {
        rows = lines;
    }
    ...
    public Object[] AddRow(Object[] values)
    {
        ...
        newId++;
        Object[] newRow = new Object[Columns.values().length];
        int len = values.length;
        System.arraycopy(values, 0, newRow,0, len);
        newRow[Columns.ID.GetId()] = newId;
    ...
    {
        if (index >= Columns.values().length || index < 0 )
